...
public interface ModuleRepository extends JpaRepository<Module, Long> {
    ...
    @Query("""
    UPDATE Module m
    SET m.deletedAt = :deletedAt, m.updatedAt = :updatedAt
    WHERE m.id = :id
    """)
    void softDeleteById(@Param("id") Long id, @Param("deletedAt") LocalDateTime deletedAt, @Param("updatedAt") LocalDateTime updatedAt);
    @Query("""
